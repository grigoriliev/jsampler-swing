...
public class JSAddOrEditInstrumentDlg extends OkCancelDialog {
	...
	private final JLabel lEngine = new JLabel(StdI18n.i18n.getLabel("JSAddOrEditInstrumentDlg.lEngine"));
	
	private final JButton btnBrowse =
		new JButton(StdI18n.i18n.getButtonLabel("browse"));
	...
	public JSAddOrEditInstrumentDlg(OrchestraInstrument instr) {
		super(SHF.getMainFrame(), StdI18n.i18n.getLabel("JSAddOrEditInstrumentDlg.title"));
		setResizable(true);
