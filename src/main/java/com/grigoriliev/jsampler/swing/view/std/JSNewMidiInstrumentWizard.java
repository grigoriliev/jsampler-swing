...
public class JSNewMidiInstrumentWizard extends Wizard {
	...
	JSNewMidiInstrumentWizard(ImageIcon iconBrowse, MidiInstrumentMap defaultMap) {
		super(SHF.getMainFrame(), StdI18n.i18n.getLabel("JSNewMidiInstrumentWizard.title"));
...
class InstrLocationMethodWizardPage extends UserInputPage {
	...
	private final JRadioButton rbManual =
		new JRadioButton(StdI18n.i18n.getLabel("InstrLocationMethodWizardPage.rbManual"));
	
	private final JRadioButton rbOrchestra =
		new JRadioButton(StdI18n.i18n.getLabel("InstrLocationMethodWizardPage.rbOrchestra"));
	
	private final JCheckBox checkSkip =
		new JCheckBox(StdI18n.i18n.getLabel("InstrLocationMethodWizardPage.checkSkip"));
	
	InstrLocationMethodWizardPage() {
		super(StdI18n.i18n.getLabel("InstrLocationMethodWizardPage.subtitle"));
		
		String s = StdI18n.i18n.getLabel("InstrLocationMethodWizardPage.mainInstructions");
...
class OrchestraSelectWizardPage extends UserInputPage {
	private final JLabel lOrchestras =
		new JLabel(StdI18n.i18n.getLabel("OrchestraSelectWizardPage.lOrchestras"));
	
	private final JLabel lInstruments =
		new JLabel(StdI18n.i18n.getLabel("OrchestraSelectWizardPage.lInstruments"));
	
	private final JLabel lLoadMode =
		new JLabel(StdI18n.i18n.getLabel("OrchestraSelectWizardPage.lLoadMode"));
...
class ManualSelectWizardPage extends UserInputPage {
	private final JLabel lFilename =
		new JLabel(StdI18n.i18n.getLabel("ManualSelectWizardPage.lFilename"));
	...
	private final JLabel lLoadMode =
		new JLabel(StdI18n.i18n.getLabel("ManualSelectWizardPage.lLoadMode"));
	...
	ManualSelectWizardPage(ImageIcon iconBrowse) {
		...
		btnBrowse.setToolTipText(StdI18n.i18n.getLabel("ManualSelectWizardPage.btnBrowse"));
		c.gridx = 2;
		c.gridy = 0;
...
class InstrumentMappingWizardPage extends WizardPage  {
	...
	private final JLabel lProgram =
		new JLabel(StdI18n.i18n.getLabel("InstrumentMappingWizardPage.lProgram"));
	
	private final JLabel lVolume =
		new JLabel(StdI18n.i18n.getLabel("InstrumentMappingWizardPage.lVolume"));
