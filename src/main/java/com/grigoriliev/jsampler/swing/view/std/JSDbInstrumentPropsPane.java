...
public class JSDbInstrumentPropsPane extends JPanel {
	private final JLabel lName = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lName"));
	private final JLabel lLocation =
		createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lLocation"));
	
	private final JLabel lSize = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lSize"));
	
	private final JLabel lFormat = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lFormat"));
	private final JLabel lType = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lType"));
	private final JLabel lDesc = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lDesc"));
	private final JLabel lCreated =
		createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lCreated"));
	private final JLabel lModified =
		createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lModified"));
	
	private final JLabel lFile = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lFile"));
	private final JLabel lIndex = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lIndex"));
	private final JLabel lProduct = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lProduct"));
	private final JLabel lArtists = createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lArtists"));
	private final JLabel lKeywords =
		createLabel(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.lKeywords"));
	...
	setInstrumentInfo(DbInstrumentInfo instrInfo) {
		...
		if(instrInfo.isDrum()) taType.setText(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.drum"));
		else taType.setText(StdI18n.i18n.getLabel("JSDbInstrumentPropsPane.chromatic"));
