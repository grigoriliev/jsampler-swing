...
import com.grigoriliev.jsampler.swing.view.*;
...
import com.grigoriliev.jsampler.swing.view.DbClipboard;
...
public class JSInstrumentsDbTable extends AbstractInstrumentsDbTable {
	...
	JSInstrumentsDbTable(JSInstrumentsDbTree tree, String columnPrefix) {
		...
		CC.getMainFrame().addChannelsPaneSelectionListener(new com.grigoriliev.jsampler.event.ListSelectionListener() {
			public void
	...
	private class ReloadAction extends AbstractAction implements TreeSelectionListener {
		ReloadAction() {
			...
			String s = StdI18n.i18n.getMenuLabel("instrumentsdb.actions.reload.tt");
	...
	class CreateDirectoryAction extends AbstractAction {
		...
		CreateDirectoryAction() {
			...
			String s = StdI18n.i18n.getMenuLabel("instrumentsdb.actions.createFolder.tt");
			putValue(SHORT_DESCRIPTION, s);
		}
	...
	class DeleteAction extends AbstractAction {
		DeleteAction() {
			...
			String s;
			s = StdI18n.i18n.getMenuLabel("instrumentsdb.actions.delete.tt");
			putValue(SHORT_DESCRIPTION, s);
			setEnabled(false);
		}
		...
		actionPerformed(ActionEvent e) {
			...
			if(dirs.length > 0) {
				String s = StdI18n.i18n.getMessage("JSInstrumentsDbTable.confirmDeletion");
	...
	class AddInstrumentsFromFileAction extends AbstractAction {
		AddInstrumentsFromFileAction() {
			...
			putValue(SHORT_DESCRIPTION, StdI18n.i18n.getMenuLabel(s));
		}
	...
	class AddToMidiMapAction extends AbstractAction {
		...
		actionPerformed(ActionEvent e) {
			...
			if(l > 4) {
				...
				s = StdI18n.i18n.getMessage(s, l, midiMap.getName());
	...
	class AddToOrchestraAction extends AbstractAction {
		...
		actionPerformed(ActionEvent e) {
			...
			if(l > 1) {
				...
				s = StdI18n.i18n.getMessage(s, l, orchestraModel.getName());
				if(!SHF.showYesNoDialog(JSInstrumentsDbTable.this, s)) return;
			}
	...
	class PropertiesAction extends AbstractAction {
		PropertiesAction() {
			...
			String s;
			s = StdI18n.i18n.getMenuLabel("instrumentsdb.actions.properties.tt");
			putValue(SHORT_DESCRIPTION, s);
			setEnabled(false);
		}
		...
		showInstrumentProperties(DbInstrumentInfo instr) {
			...
			String s = StdI18n.i18n.getLabel("JSInstrumentsDbTable.instrProps");
			showDialog(s, p);
		}
		...
		showDirectoryProperties(DbDirectoryInfo dir) {
			...
			String s = StdI18n.i18n.getLabel("JSInstrumentsDbTable.dirProps");
			showDialog(s, p);
		}
	...
	class RenameAction extends AbstractAction {
		...
		RenameAction() {
			...
			String s = StdI18n.i18n.getMenuLabel("instrumentsdb.edit.rename.tt");
			putValue(SHORT_DESCRIPTION, s);
			setEnabled(false);
		}
	...
	class ChangeDescriptionAction extends AbstractAction {
		...
		ChangeDescriptionAction() {
			...
			String s = StdI18n.i18n.getMenuLabel("instrumentsdb.edit.description.tt");
			putValue(SHORT_DESCRIPTION, s);
			setEnabled(false);
		}
	...
	class CutAction extends AbstractAction {
		CutAction() {
			...
			String s = StdI18n.i18n.getMenuLabel("instrumentsdb.edit.cut.tt");
			putValue(SHORT_DESCRIPTION, s);
			setEnabled(false);
		}
	...
	class CopyAction extends AbstractAction {
		CopyAction() {
			...
			String s = StdI18n.i18n.getMenuLabel("instrumentsdb.edit.copy.tt");
			putValue(SHORT_DESCRIPTION, s);
			setEnabled(false);
		}
	...
	class PasteAction extends AbstractAction implements TreeSelectionListener, ChangeListener {
		PasteAction() {
			...
			String s = StdI18n.i18n.getMenuLabel("instrumentsdb.edit.paste.tt");
			putValue(SHORT_DESCRIPTION, s);
			setEnabled(false);
	...
	class InstrumentsDbCellRenderer extends JLabel implements TableCellRenderer {
		...
		getTableCellRendererComponent (
			...
			InstrumentsDbTableModel.ColumnType ct =
				((InstrumentsDbTableModel)table.getModel()).getColumnType(column);
			
			if(ct == InstrumentsDbTableModel.ColumnType.IS_DRUM || ct == InstrumentsDbTableModel.ColumnType.FORMAT_FAMILY) {
				setHorizontalAlignment(CENTER);
			} else  if (    ct == InstrumentsDbTableModel.ColumnType.SIZE ||
					ct == InstrumentsDbTableModel.ColumnType.INSTRUMENT_NR ||
					ct == InstrumentsDbTableModel.ColumnType.FORMAT_VERSION
				) {
	...
	class ContextMenu extends MouseAdapter {
		...
		ContextMenu() {
			...
			String s = StdI18n.i18n.getMenuLabel("instrumentsdb.actions.addInstruments");
			...
			s = StdI18n.i18n.getMenuLabel("instrumentsdb.actions.loadInstrument");
			...
			s = StdI18n.i18n.getMenuLabel("instrumentsdb.actions.addToMidiMap");
			...
			s = StdI18n.i18n.getMenuLabel("instrumentsdb.actions.addToOrchestra");
