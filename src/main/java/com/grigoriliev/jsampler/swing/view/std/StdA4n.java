...
public class StdA4n {
	...
	private static class DuplicateChannels extends AbstractAction {
		...
		actionPerformed(ActionEvent e) {
			...
			CC.getTaskQueue().add (
				new com.grigoriliev.jsampler.task.DuplicateChannels(channels)
			);
		}
	}
	...
	public static class
	MoveChannelsToPanel extends AbstractAction implements com.grigoriliev.jsampler.event.ListSelectionListener {
