...
public class JSAdvancedGeneralPropsDlg extends OkCancelDialog {
	...
	JSAdvancedGeneralPropsDlg(Dialog owner) {
		super(owner, StdI18n.i18n.getLabel("JSAdvancedGeneralPropsDlg.title"));
	...
	public static class MidiBankProgramNumberingPane extends JPanel {
		private final JLabel lFirstBank =
			new JLabel(StdI18n.i18n.getLabel("JSAdvancedGeneralPropsDlg.lFirstBank"));
		
		private final JLabel lFirstProgram =
			new JLabel(StdI18n.i18n.getLabel("JSAdvancedGeneralPropsDlg.lFirstProgram"));
		...
		MidiBankProgramNumberingPane() {
			...
			String s = StdI18n.i18n.getLabel("MidiBankProgramNumberingPane.title");
	...
	public static class ExportSettingsPane extends JPanel {
		private final JCheckBox checkExportMidiMapsToSession =
			new JCheckBox(StdI18n.i18n.getLabel("ExportSettingsPane.checkExportMidiMapsToSession"));
		
		private final JCheckBox checkLoadInstrInBackground =
			new JCheckBox(StdI18n.i18n.getLabel("ExportSettingsPane.checkLoadInstrInBackground"));
		...
		ExportSettingsPane() {
			...
			String s = StdI18n.i18n.getLabel("ExportSettingsPane.title");
			setBorder(BorderFactory.createTitledBorder(s));
			setAlignmentX(LEFT_ALIGNMENT);
		}
