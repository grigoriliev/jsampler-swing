...
public class JSAddDbInstrumentsFromFileDlg extends OkCancelDialog {
	private final JRadioButton rbAllInstruments =
		new JRadioButton(StdI18n.i18n.getLabel("JSAddDbInstrumentsFromFileDlg.rbAllInstruments"));
	private final JRadioButton rbIndex =
		new JRadioButton(StdI18n.i18n.getLabel("JSAddDbInstrumentsFromFileDlg.rbIndex"));
	...
	JSAddDbInstrumentsFromFileDlg(Frame owner, String dbDir, Icon iconBrowse) {
		super(owner, StdI18n.i18n.getLabel("JSAddDbInstrumentsFromFileDlg.title"));
	...
	initAddDbInstrumentsFromFileDlg(String dbDir, Icon iconBrowse) {
		...
		String s = StdI18n.i18n.getButtonLabel("browse");
		...
		s = StdI18n.i18n.getLabel("JSAddDbInstrumentsFromFileDlg.source");
		...
		p2.add(cbDest);
		p2.add(Box.createRigidArea(new Dimension(6, 0)));
		s = StdI18n.i18n.getButtonLabel("browse");
		...
		s = StdI18n.i18n.getLabel("JSAddDbInstrumentsFromFileDlg.dest");
		p.setBorder(BorderFactory.createTitledBorder(s));
