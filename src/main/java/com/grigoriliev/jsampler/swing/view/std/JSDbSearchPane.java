...
public abstract class JSDbSearchPane extends JPanel {
	...
	private final JLabel lDescription =
		new JLabel(StdI18n.i18n.getLabel("JSDbSearchPane.lDescription"));
	...
	JSDbSearchPane(final Frame owner) {
		...
		String s = StdI18n.i18n.getLabel("JSDbSearchPane.typeCriteria");
		p.add(createCriteriaPane(s, typeCriteriaPane));
		p.add(Box.createRigidArea(new Dimension(0, 6)));
		
		s = StdI18n.i18n.getLabel("JSDbSearchPane.modifiedCriteria");
		p.add(createCriteriaPane(s, dateModifiedPane));
		p.add(Box.createRigidArea(new Dimension(0, 6)));
		
		s = StdI18n.i18n.getLabel("JSDbSearchPane.createdCriteria");
		p.add(createCriteriaPane(s, dateCreatedPane));
		p.add(Box.createRigidArea(new Dimension(0, 6)));
		
		s = StdI18n.i18n.getLabel("JSDbSearchPane.sizeCriteria");
		...
		s = StdI18n.i18n.getLabel("JSDbSearchPane.isDrumCriteria");
		p.add(createCriteriaPane(s, isDrumCriteriaPane));
		p.add(Box.createRigidArea(new Dimension(0, 6)));
		
		s = StdI18n.i18n.getLabel("JSDbSearchPane.moreCriterias");
	...
	class TypeCriteriaPane extends JPanel implements ActionListener {
		private JRadioButton rbInstruments =
			new JRadioButton(StdI18n.i18n.getLabel("TypeCriteriaPane.rbInstruments"));
		private JRadioButton rbDirectories =
			new JRadioButton(StdI18n.i18n.getLabel("TypeCriteriaPane.rbDirectories"));
		private JRadioButton rbBoth =
			new JRadioButton(StdI18n.i18n.getLabel("TypeCriteriaPane.rbBoth"));
	...
	class DateCriteriaPane extends JPanel implements ActionListener {
		private JRadioButton rbDontRemember =
			new JRadioButton(StdI18n.i18n.getLabel("DateCriteriaPane.rbDontRemember"));
		private JRadioButton rbSpecifyDates =
			new JRadioButton(StdI18n.i18n.getLabel("DateCriteriaPane.rbSpecifyDates"));
		...
		DateCriteriaPane() {
			...
			JLabel l = new JLabel(StdI18n.i18n.getLabel("DateCriteriaPane.from"));
			c.gridx = 0;
			c.gridy = 0;
			...
			l = new JLabel(StdI18n.i18n.getLabel("DateCriteriaPane.to"));
			c.gridx = 0;
			c.gridy = 1;
			gridbag.setConstraints(l, c);
			p.add(l); 
	...
	class SizeCriteriaPane extends JPanel implements ActionListener {
		private JRadioButton rbDontRemember =
			new JRadioButton(StdI18n.i18n.getLabel("SizeCriteriaPane.rbDontRemember"));
		private JRadioButton rbSpecifySize =
			new JRadioButton(StdI18n.i18n.getLabel("SizeCriteriaPane.rbSpecifySize"));
		...
		SizeCriteriaPane() {
			...
			JLabel l = new JLabel(StdI18n.i18n.getLabel("SizeCriteriaPane.from"));
			c.gridx = 0;
			c.gridy = 0;
			c.anchor = GridBagConstraints.WEST;
			c.insets = new Insets(3, 18, 3, 3);
			...
			l = new JLabel(StdI18n.i18n.getLabel("SizeCriteriaPane.to"));
			c.gridx = 0;
			c.gridy = 1;
			gridbag.setConstraints(l, c);
			p.add(l); 
	...
	class FormatCriteriaPane extends JPanel implements ItemListener {
		private JCheckBox checkAllFormats =
			new JCheckBox(StdI18n.i18n.getLabel("FormatCriteriaPane.checkAllFormats"));
		private JCheckBox checkGigFormat =
			new JCheckBox(StdI18n.i18n.getLabel("FormatCriteriaPane.checkGigFormat"));
	...
	class IsDrumCriteriaPane extends JPanel {
		private JRadioButton rbBoth =
			new JRadioButton(StdI18n.i18n.getLabel("IsDrumCriteriaPane.rbBoth"));
		private JRadioButton rbChromatic =
			new JRadioButton(StdI18n.i18n.getLabel("IsDrumCriteriaPane.rbChromatic"));
		private JRadioButton rbDrum =
			new JRadioButton(StdI18n.i18n.getLabel("IsDrumCriteriaPane.rbDrum"));
	...
	class MoreCriteriasPane extends JPanel {
		private final JLabel lProduct =
			new JLabel(StdI18n.i18n.getLabel("MoreCriteriasPane.lProduct"));
		private final JLabel lArtists =
			new JLabel(StdI18n.i18n.getLabel("MoreCriteriasPane.lArtists"));
		private final JLabel lKeywords =
			new JLabel(StdI18n.i18n.getLabel("MoreCriteriasPane.lKeywords"));
