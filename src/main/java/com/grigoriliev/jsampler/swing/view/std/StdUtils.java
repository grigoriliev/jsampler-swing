...
import com.grigoriliev.jsampler.swing.view.JSFileFilter;
...
public class StdUtils {
	...
	checkDesktopSupported() {
		...
		String s = StdI18n.i18n.getError("StdUtils.DesktopApiNotSupported");
	...
	private static class VolumeSlider extends JSlider {
		...
		VolumeSlider() {
			...
			if(b) tip.setTipText(StdI18n.i18n.getLabel("StdUtils.volumeDecibels", "-30.0"));
			else tip.setTipText(StdI18n.i18n.getLabel("StdUtils.volume", "100"));
			tip.setPreferredSize(tip.getPreferredSize());
			tip.setMinimumSize(tip.getPreferredSize());
			///////
			tip.setComponent(this);
			tip.setTipText(StdI18n.i18n.getLabel("StdUtils.volume", 0));
			...
			preferences().addPropertyChangeListener(s, new PropertyChangeListener() {
				...
				propertyChange(PropertyChangeEvent e) {
					...
					String s;
					if(b) s = StdI18n.i18n.getLabel("StdUtils.volumeDecibels", "-30.0");
					else s = StdI18n.i18n.getLabel("StdUtils.volume", "100");
					tip.setTipText(s);
					tip.setPreferredSize(tip.getPreferredSize());
					tip.setMinimumSize(tip.getPreferredSize());
					///////
		...
		updateVolumeInfo() {
			...
			if(CC.getViewConfig().isMeasurementUnitDecibel()) {
				...
				s = StdI18n.i18n.getLabel("StdUtils.volumeDecibels", numberFormat.format(d));
			} else {
				s = StdI18n.i18n.getLabel("StdUtils.volume", getValue());
			}
