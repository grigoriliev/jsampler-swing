...
import com.grigoriliev.jsampler.swing.view.FxSendTable;
...
import com.grigoriliev.jsampler.event.EffectSendsAdapter;
...
public class JSFxSendsPane extends JPanel implements ListSelectionListener {
	...
	class AddFxSendAction extends AbstractAction {
		...
		AddFxSendAction() {
			...
			String s = StdI18n.i18n.getLabel("JSFxSendsPane.AddFxSendAction.tt");
	...
	class RemoveFxSendAction extends AbstractAction {
		RemoveFxSendAction() {
			...
			String s = StdI18n.i18n.getLabel("JSFxSendsPane.RemoveFxSendAction.tt");
			putValue(SHORT_DESCRIPTION, s);
		}
	...
	class ChannelRoutingTable extends JTable {
		private String[] columnToolTips = {
			StdI18n.i18n.getLabel("JSFxSendsPane.ttAudioSrc"),
			StdI18n.i18n.getLabel("JSFxSendsPane.ttAudioDst"),
		};
	...
	class ChannelRoutingTableModel extends AbstractTableModel implements ListSelectionListener {
		private String[] columnNames = {
			StdI18n.i18n.getLabel("JSFxSendsPane.audioSrc"),
			StdI18n.i18n.getLabel("JSFxSendsPane.audioDst")
		};
