...
import com.grigoriliev.jsampler.swing.view.ServerTable;
import com.grigoriliev.jsampler.swing.view.ServerTableModel;
...
public class JSConnectionPropsPane extends JPanel {
	private final JCheckBox checkManualSelect =
		new JCheckBox(StdI18n.i18n.getLabel("JSConnectionPropsPane.checkManualSelect"));
	
	private final JLabel lReadTimeout =
		new JLabel(StdI18n.i18n.getLabel("JSConnectionPropsPane.lReadTimeout"));
	...
	createServerListPane() {
		...
		String s = StdI18n.i18n.getLabel("JSConnectionPropsPane.title");
	...
	public static class ServerListPane extends JPanel {
		...
		private final JButton btnMoveUp =
			new JButton(StdI18n.i18n.getButtonLabel("JSConnectionPropsPane.btnMoveUp"));
		
		private final JButton btnMoveDown =
			new JButton(StdI18n.i18n.getButtonLabel("JSConnectionPropsPane.btnMoveDown"));
		...
		removeServer() {
			if(CC.getServerList().getServerCount() < 2) {
				Window w = JuifeUtils.getWindow(this);
				String s = StdI18n.i18n.getError("JSConnectionPropsPane.cantRemove");
	...
	public static class LocalSettingsPane extends JPanel {
		private final JCheckBox checkLaunchBackend =
			new JCheckBox(StdI18n.i18n.getLabel("JSConnectionPropsPane.checkLaunchBackend"));
		
		private final JLabel lCommand =
			new JLabel(StdI18n.i18n.getLabel("JSConnectionPropsPane.lCommand"));
		
		private final JLabel lDelay =
			new JLabel(StdI18n.i18n.getLabel("JSConnectionPropsPane.lDelay"));
		
		private final JLabel lSeconds =
			new JLabel(StdI18n.i18n.getLabel("JSConnectionPropsPane.lSeconds"));
		...
		LocalSettingsPane() {
			...
			String s = StdI18n.i18n.getLabel("JSConnectionPropsPane.localSettings");
