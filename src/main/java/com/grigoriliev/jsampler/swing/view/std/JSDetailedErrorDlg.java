...
public class JSDetailedErrorDlg extends EnhancedDialog {
	...
	private final JButton btnDetails =
		new JButton(StdI18n.i18n.getButtonLabel("JSDetailedErrorDlg.showDetails"));
	...
	showDetails(final boolean b) {
		if(b) btnDetails.setText(StdI18n.i18n.getButtonLabel("JSDetailedErrorDlg.hideDetails"));
		else btnDetails.setText(StdI18n.i18n.getButtonLabel("JSDetailedErrorDlg.showDetails"));
